...
# Configuration Files (Checks Download folder for easier user access)
CONFIG_FILE = "bot_config.json"
DATA_FILE = "bot_data.json"

if os.path.exists("/sdcard/Download/bot_config.json"):
    CONFIG_FILE = "/sdcard/Download/bot_config.json"
if os.path.exists("/sdcard/Download/bot_data.json"):
    DATA_FILE = "/sdcard/Download/bot_data.json"
